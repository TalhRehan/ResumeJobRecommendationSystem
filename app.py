...
tfidf_vecorizer_categorization = pickle.load(open('tfidf_vecorizer_categorization.pkl','rb'))
rf_classifier_job_recommendation = pickle.load(open('rf_classifier_job_recommendation.pkl','rb'))
tfidf_vecorizer_job_recommendation = pickle.load(open('tfidf_vectorizer_job_recommendation.pkl','rb'))
def cleanResume(txt):
...
def predict_category(resume_text):
    ...
    resume_tfidf = tfidf_vecorizer_categorization.transform([resume_text])
    predicted_category = rf_classifier_categorization.predict(resume_tfidf)[0]
    return predicted_category
def job_recommendation(resume_text):
    resume_text = cleanResume(resume_text)
    resume_tfidf = tfidf_vecorizer_job_recommendation.transform([resume_text])
...
def pred():
    if 'resume' in request.files:
        ...
        return  render_template('resume.html',message="No resume file upload. ")
